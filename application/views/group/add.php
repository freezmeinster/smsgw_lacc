...
<tr>
	...
	<!-- start id-form -->
	<form action="<?php echo site_url('group/group_add_post');?>" method="POST">
	<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top"><?php get_line('group_name');?>:</th>
			<td><input type="text" class="inp-form" name="nama_group"/></td>
			<td></td>
		</tr>
		
		<tr>
			<th valign="top"><?php get_line('group_desc');?>:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="keterangan"></textarea></td>
			<td></td>
		</tr>
