		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href=""><?php get_line('group_name');?></a></th>
					<th class="table-header-repeat line-left minwidth-1"><a href=""><?php get_line('group_desc');?></a></th>
