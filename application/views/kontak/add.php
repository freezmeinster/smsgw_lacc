...
<tr>
	...
	<!-- start id-form -->
	<form action="<?php echo site_url('kontak/kontak_new');?>" method="POST">
	<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top"><?php get_line('contact_name');?>:</th>
			<td><input type="text" class="inp-form" name="nama"/></td>
			<td></td>
		</tr>
		
		<tr>
			<th valign="top"><?php get_line('contact_phone');?>:</th>
			<td><input type="text" class="inp-form" name="no_telp"/></td>
			<td></td>
		</tr>
