...
<script type='text/javascript' SRC="<?php echo base_url();?>/asset/scripts/jquery.qtip.js"></script>
...
<link href="<?php echo base_url();?>/asset/styles/jquery-ui.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url();?>/asset/styles/jquery.qtip.css" rel="stylesheet" type="text/css" />
...
<body id="homepage">
	<div id="header">
    	<a href="" title=""><img SRC="<?php echo base_url();?>/asset/img/cp_logo.png" alt="Control Panel" class="logo" /></a>
    </div>
        
    <!-- Top Breadcrumb Start -->
    <div id="breadcrumb">
    	<ul>	
        	<li><img SRC="<?php echo base_url();?>/asset/img/icons/icon_breadcrumb.png" alt="Location" /></li>
        	<li><strong>Location:</strong></li>
            <li><a href="#" title="">Sistem</a></li>
            <li>/</li>
            <li class="current">Aset Anda</li>
        </ul>
    </div>